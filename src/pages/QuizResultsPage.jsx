			...
			<main className="relative">
									...
									<div className="flex space-x-4 min-w-max">
										{recommendedQuizzes.map((quiz) => (
											<button
												...
												className="flex-shrink-0 w-40 bg-gradient-to-br from-white to-amber-50/30 rounded-xl p-3 border border-amber-200/50 hover:border-amber-300 hover:shadow-lg transition-all duration-300 text-left"
											>
												...
												<span className="inline-block px-2 py-0.5 text-xs bg-amber-100 text-amber-700 rounded-md">
													{quiz.difficulty}
												</span>
											</button>
										))}
					...
					<div className="w-1/2 flex-shrink-0 overflow-y-auto p-8">
						<div className="max-w-2xl mx-auto space-y-6">
							...
							<div className="flex gap-4">
								<button
									onClick={() => onNavigate('setup')}
									className="flex-1 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-semibold py-3 px-6 rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-300"
								>
									Take New Quiz
								</button>
								<button
									onClick={() => onNavigate('story')}
									className="flex-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold py-3 px-6 rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-300"
								>
									Story Mode
								</button>
							</div>
				...
				<div className="lg:hidden px-4 sm:px-6 pb-6 pt-24 space-y-6">
					...
					<div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
						<button
							onClick={() => onNavigate('setup')}
							className="flex-1 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-semibold py-3 px-4 rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-300 text-sm sm:text-base"
						>
							Take New Quiz
						</button>
						<button
							onClick={() => onNavigate('story')}
							className="flex-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold py-3 px-4 rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-300 text-sm sm:text-base"
						>
							Story Mode
						</button>
					</div>
